...
def handle_send_message(data):
    ...
    if msg_type == 'text': message_to_forward['content'] = data.get('text'); db.save_message(sender, recipient, message_to_forward['content'], msg_type)
    elif msg_type == 'file_uploading': message_to_forward['filename'] = data.get('filename')
    elif msg_type == 'file_upload_cancelled': pass
    elif msg_type == 'file': message_to_forward['url'] = data.get('url'); message_to_forward['filename'] = data.get('filename'); db.save_message(sender, recipient, None, msg_type, message_to_forward['url'], message_to_forward['filename'])
